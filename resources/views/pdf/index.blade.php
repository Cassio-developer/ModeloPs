        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody style="text-align: center">
                    @foreach ($protos as $protocolos)
                    <tr>
                        <td>{{$protocolos->cadastropessoass->nome}}</td>
                        <td>{{$protocolos->DataRequisicao->format('d-m-Y')}}</td>
                        <td>{{$protocolos->descricao}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
