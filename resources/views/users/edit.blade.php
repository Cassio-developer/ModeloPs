...
@endif
    ...
    <form action="{{ route('users.update', $user->id) }}" method="post" class="form-horizontal">
        ...
        @method('PUT')
            ...
            <div class="input">
        <input type="text" class="form-control" name="name"  @error('name') is-invalid @enderror value="{{ old('name', $user->name) }}" autofocus
        ...
        class="form-control @error('email') is-invalid @enderror" name="cpf"
            value="{{ old('cpf') }}" autocomplete="cpf" autofocus placeholder="cpf" data-mask="000.000.000-00">
    @error('cpf')
    <span class="invalid-feedback" role="alert">
        {{ $message }}
    </span>
    ...
    <input type="password" class="form-control" name="password" value="{{ old('password') }}"
        class="form-control @error('password') is-invalid @enderror" name="password"
            value="{{ old('password') }}" autocomplete="current-password" autofocus placeholder="password"  required>
